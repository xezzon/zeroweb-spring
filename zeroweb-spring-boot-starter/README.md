...
| spring.grpc.client.channels.admin.address | 远程调用系统管理服务的地址。                                                              | zeroweb-service-admin:10002 |
| spring.grpc.client.channels.file.address  | 远程调用附件管理服务的地址。                                                              | zeroweb-service-file:10002  |
